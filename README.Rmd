---
title: "GxEScanR: Performs GWAS/GWIS analyses using BinaryDosage files"
...
GxEScanR is designed to efficiently run GWAS/GWIS scans using imputed genotypes
stored in the BinaryDosageformat. The phenotype to be analyzed can either be a
continuous or binary trait. The GWIS scan performs multiple tests that can be
