...
GxEScanR is designed to efficiently run genomewide association study (GWAS) and genomewide environmental interaction study (GWEIS) scans using imputed genotypes
